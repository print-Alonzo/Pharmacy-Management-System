...
%>       
        ...
        <a href="employee_list_all.jsp">Employee List</a><br>
        <a href="employee_search.jsp">Search Employee</a></br>
        <a href="employee_add.jsp"> Add Employee </a> </br>
        <a href="employee_update.jsp">Update Employee Information</a></br>
        <a href="employee_delete.jsp"> Remove an employee</a></br>
