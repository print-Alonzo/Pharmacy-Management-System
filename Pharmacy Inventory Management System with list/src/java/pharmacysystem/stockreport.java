...
public class stockreport {
    ...
    public int generateStockReport(){
        try{
            ...
            String query1 = "SELECT i.medicine_id, i.brand_name, YEAR(s.dateReceived) AS 'year_report', MONTH(s.dateReceived) AS 'month_report', COUNT(s.stock_id) AS 'Amount_Received'\n" +
...
"                            ORDER BY year_report, month_report, Amount_Received;\n";
            
            medicineIDList1.clear();
            brandNameList1.clear();
            yearList1.clear();
            monthList1.clear();
            received1.clear();
            
            medicineIDList2.clear();
            brandNameList2.clear();
            yearList2.clear();
            monthList2.clear();
            expired2.clear();
            
            medicineIDList3.clear();
            brandNameList3.clear();
            yearList3.clear();
            monthList3.clear();
            sold3.clear();
            ...
            while(rs1.next()){
                ...
                int amountReceived = rs1.getInt("Amount_Received");
            ...
            String query2 = "SELECT i.medicine_id, i.brand_name, YEAR(t.transactionDate) AS 'year_report', MONTH(t.transactionDate) AS 'month_report', COUNT(s.stock_id) AS 'Amount Sold'\n" +
                            ...
                            "GROUP BY i.medicine_id, year_report, month_report\n" +
                            "ORDER BY year_report, month_report, 'Amount Sold'";
            ...
            String query3 = "SELECT s.medicine_id, i.brand_name, YEAR(s.dateExpire) AS 'year_report', MONTH(s.dateExpire) AS 'month_report', COUNT(s.stock_id) AS 'Amount_Expiring'\n" +
                            "FROM medicine_stock s LEFT JOIN medicine_info i\n" +
                            "					  ON s.medicine_id = i.medicine_id\n" +
                            "WHERE s.transactionID IS NULL\n" +
                            "GROUP BY s.medicine_id, year_report, month_report\n" +
                            "ORDER BY year_report, month_report, 'Amount_Expiring'";
            ...
            while(rs3.next()){
                ...
                int amountReceived = rs3.getInt("Amount_Expiring");
    ...
    public static void main(String[] args){
        ...
        for(String brand : sr.brandNameList1){
