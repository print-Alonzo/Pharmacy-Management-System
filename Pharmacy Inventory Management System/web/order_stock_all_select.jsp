...
<html>
    ...
    <body>
        ...
        <jsp:useBean id="D" class="pharmacysystem.medicines" scope="session" />
        <%
            D.get_all_meds();
            for (int i = 0; i < D.medicineIDList.size(); i++) {
                D.get_info_for_order(D.medicineIDList.get(i));
        %>
                <div class="medicine-info">
                    Medicine ID: <%=D.medicineID%><br>
                    Brand Name: <%=D.brand_name%><br>
                    Generic Name: <%=D.generic_name%><br>
                    Stock: <%=D.stock%><br>
                    Supplier ID: <%=D.supplier_id%><br>
                    Supplier Name: <%=D.supplier_name%><br>
                    Unit Price: <%=D.sellingPrice%><br>
                </div>
        <%
            }
        %> 
