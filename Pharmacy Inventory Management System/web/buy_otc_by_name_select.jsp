<%-- 
    Document   : buy_otc_by_name
    Created on : 11 18, 23, 2:52:17 PM
    Author     : ccslearner
--%>
...
<head>
    ...
    <title>Select OTC Medicine</title>
    <style>
        body {
...
<!-- Display Info of Over-the-counter Medicines -->
<h1>Available Over-the-counter Medicines</h1>
<jsp:useBean id="A" class="pharmacysystem.medicines" scope="session" />
<%
    String searched_name = request.getParameter("name");
    A.get_meds_with_name(searched_name, 0);
